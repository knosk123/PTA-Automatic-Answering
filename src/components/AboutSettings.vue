...
<template>
  <div class="about-content">
    ...
    <div class="section">
      ...
      <div class="section-content">
        <p><strong>作者:</strong> knosk123</p>
        <p><strong>开源地址:</strong> <a href="https://github.com/knosk123/PTA-Automatic-Answering" target="_blank">https://github.com/knosk123/PTA-Automatic-Answering</a></p>
